...
public class MethodParamNamesScanner {
    ...
    public static String[] methodParamNames(Class<?> clazz, Method m) throws IOException {
        List<String> result = getMethodParamNames(clazz, m);
     ...
     * @throws IOException
     */
    private static List<String> getMethodParamNames(Class<?> clazz, Method m) throws IOException {
    ...
    private static List<String> getMethodParamNames(InputStream in, Method m) throws IOException {
     ...
     */
    /*
     * private static List<String> getConstructorParamNames(Class<?> clazz,
     * Constructor<?> constructor) { try (InputStream in =
     * clazz.getResourceAsStream("/" + clazz.getName().replace('.', '/') +
     * ".class")) { return getConstructorParamNames(in, constructor); } catch
     * (IOException e) { // TODO Auto-generated catch block e.printStackTrace();
     * } return new ArrayList<String>(); }
     */
    /*
     * private static List<String> getConstructorParamNames(InputStream ins,
     * Constructor<?> constructor) { try (InputStream in = ins) { return
     * getParamNames(in, new
     * EnclosingMetadata(constructor.getName(),Type.getConstructorDescriptor
     * (constructor), constructor.getParameterTypes().length)); } catch
     * (IOException e1) { // TODO Auto-generated catch block
     * e1.printStackTrace(); } return new ArrayList<String>(); }
     */
    /**
     * 获取参数名列表辅助方法
     * 
    ...
    /*
     * public static void main(String[] args) throws IOException { for (Method m
     * : MethodLogAspect.class.getDeclaredMethods()) { List<String> list =
     * getMethodParamNames(MethodLogAspect.class, m);
     * System.out.println(m.getName() + ":"); for (String str : list) {
